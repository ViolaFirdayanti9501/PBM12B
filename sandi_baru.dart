...
class BaruScreen extends StatefulWidget {
  const BaruScreen({Key? key}) : super(key: key);

  @override
  State<BaruScreen> createState() => _BaruScreenState();
}

class _BaruScreenState extends State<BaruScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    formInput(
                      marginTop: 20,
                      marginButton: 0,
                      textValue: 'Konfirmasi Kata Sandi',
                      obscureText: true,
                      checkValidator: (val) {
                        if (val == null) {
                          return 'Kata sandi harus diisi';
